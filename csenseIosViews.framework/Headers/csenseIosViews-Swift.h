...
SWIFT_MODULE_NAMESPACE_PUSH("csenseIosViews")
@class NSCoder;

SWIFT_CLASS("_TtC14csenseIosViews11BaseNibView")
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC14csenseIosViews15SimpleTableView")
...
SWIFT_CLASS("_TtC14csenseIosViews19SpacerTableViewCell")
...
/// but we want that, so we will translate the sectionIndex ( 0-> count of section) into the given key, using
/// an ordered Dictionary (so the keys will be sorted).
SWIFT_CLASS("_TtC14csenseIosViews18TableDataContainer")
@interface TableDataContainer : NSObject <UITableViewDataSource, UITableViewDelegate>
...
@interface UIView (SWIFT_EXTENSION(csenseIosViews))
